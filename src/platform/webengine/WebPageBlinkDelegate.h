...
public:
    ...
    virtual void handleBrowserControlCommand(const std::string& command, const std::list<std::string>& arguments) = 0;
    virtual void handleBrowserControlFunction(const std::string& command, const std::list<std::string>& arguments, std::string* result) = 0;
